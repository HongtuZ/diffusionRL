...
case $env in
    "walker")
        ...
        python main.py --env walker2d-expert-v2 --agent $agent --eta 1 --eta_lr 0.001 --bc_threshold 1 --rho 1 --q_tar lcb --num_seed $num_seed --gpu "$gpu" --num_qs 10 --clean_q_std_k $clean_q_std_k
    ...
    "hopper")
        ...
        python main.py --env hopper-expert-v2 --agent $agent --eta 1 --eta_lr 0.001 --bc_threshold 1 --rho 1.5 --q_tar lcb --num_seed $num_seed --gpu "$gpu" --num_qs 10 --clean_q_std_k $clean_q_std_k
    ...
    "halfcheetah")
        ...
        python main.py --env halfcheetah-expert-v2 --agent $agent --eta 1 --eta_lr 0.001 --bc_threshold 1 --q_tar lcb --rho 0 --q_tar lcb --num_seed $num_seed --gpu "$gpu" --num_qs 10 --clean_q_std_k $clean_q_std_k
